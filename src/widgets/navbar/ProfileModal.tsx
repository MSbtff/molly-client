...
export default function ProfileModal({ setIsOpen, setIsNotificationOpen }: ProfileModalProps) {
    ...
    return (
        <>
            ...
            {/* 모달 */}
            <div className="absolute right-[60px] top-[60px] w-[200px] bg-white p-6 rounded-2xl shadow-lg z-50"
