...
const banners = [
    ...
    { image: banner4, title: "새로운 시작", subtitle: "신상 컬렉션을 만나보세요" },
    { image: banner5, title: "성큼 다가온 봄을 위한", subtitle: "봄맞이 아우터 10% 쿠폰" },
    { image: banner6, title: "편안한 스타일", subtitle: "트렌디한 디자인과 함께" },
    { image: banner7, title: "우리 아이 옷장 고민 끝", subtitle: "키즈 4대 브랜드 대전" },
    { image: banner8, title: "간절기에 꼭 필요한", subtitle: "신상 가디건" },
    { image: banner9, title: "모던 클래식", subtitle: "어디서든 빛나는 스타일" }, 
    { image: banner10, title: "설레는 봄, 3월 뷰티데이", subtitle: "3천원 특가+최대 10% 쿠폰" },
];
