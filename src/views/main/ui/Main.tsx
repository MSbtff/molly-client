          ...
          {categories.map((category, index) => (
            <button
              ...
              className={`px-4 py-2 rounded-full border border-gray-600${
                index === 0 ? 'bg-black text-white' : 'bg-gray'
              }`}
            >
              {category}
            </button>
          ...
          {[...Array(6)].map((_, index) => (
            <div key={index} className="flex flex-col w-full overflow-hidden">
              ...
              <button className="flex flex-col items-start w-full overflow-hidden">
                ...
                <span className="text-left text-sm text-gray-500 truncate w-full">
                  BOA FLEECE PADDING JACKET_2COLOR
                </span>
                <span className="text-left text-black-500 font-semibold">
                  150,000원
                </span>
        ...
        <div className="w-full grid grid-cols-6 lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-2 gap-2">
          {[...Array(10)].map((_, index) => (
            ...
            >
              ...
              />
              <button className="flex flex-col items-start w-full overflow-hidden">
                <span className="text-left mt-2 font-semibold text-sm">
                  지비에이치 어패럴
                </span>
                <span className="text-left text-xs text-gray-500 truncate w-full">
                  HIGH-NECK TOGGLE COAT_CHARCOAL
                </span>
                <span className="text-left text-black-500 font-semibold text-sm">
                  35% 48,655원
                </span>
              </button>
            </div>
